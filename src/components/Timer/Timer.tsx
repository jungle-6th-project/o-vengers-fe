...
const Timer = () => {
  ...
  return (
    <div className="flex flex-col items-center mr-6 bg-black justify-self-end w-timer h-groupList justify-evenly rounded-2xl min-h-header-min max-h-header-max min-w-timer">
